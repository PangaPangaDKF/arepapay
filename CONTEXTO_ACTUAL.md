...
> Última actualización: [FECHA] — actualiza esto siempre
...
- **Romper barreras web0→web3** = cualquier persona, aunque no sepa de crypto, puede usarlo
- **La arepa es venezolana** = identidad cultural, orgullo, humor venezolano

**Tono de comunicación:** cercano, venezolano, sin jerga crypto complicada, inclusivo
...
- Los tickets se usan para entrar a rifas de premios físicos (helados, internet, etc.)
...
```
~/
├── arepapay/                        ← Repo principal en GitHub
│   └── contracts-foundry/           ← Contratos Solidity (Foundry)
│       ├── src/
...
| # | Tarea | Por qué |
|---|-------|---------|
| 1 | Refactor RewardNFT → sistema de tickets | Sin esto el frontend no puede dar/quemar tickets |
